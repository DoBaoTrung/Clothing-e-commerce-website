                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="run-customer">
                                            ...
                                            <form action="{{ route('user.change_new_password') }}" method="POST"
                                                id="form__js">
                                                <input type="text" value="{{ $token }}" hidden name="token">
                                                @csrf
                                                <div class="form-group">
                                                    <label class= "contentEmail" for="exampleInputEmail1">Mật Khẩu
                                                        Mới</label>
                                                ...
                                                <div class="form-group">
                                                    <label class= "contentEmail" for="exampleInputEmail1">Xác Nhận Mật Khẩu
                                                        Mới</label>
                                                    <input type="password" class="form-control"
