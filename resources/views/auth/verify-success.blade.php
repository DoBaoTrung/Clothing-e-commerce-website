                                ...
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <div class="run-customer">
                                            @if (Session::has('status') && session('status') == 'verifify-success')
                                                <p class="text-center text-notification">Chúc mừng bạn tài khoản của bạn đã
                                                    được xác thực thành công</p>
                                            @elseif(Session::has('status') && session('status') == 'forgot-password-success')
                                                <p class="text-center text-notification">Chúc mừng bạn đã thay đổi mật khẩu
                                                    thành công</p>
                                            @endif
                                        </div>
