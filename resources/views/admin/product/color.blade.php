...
@section('content')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img style="width:100px;"
                                                    src="{{ asset("asset/client/images/products/small/$productColor->img") }}"
                                                    alt="">
                                            </td>
                                            <td>
                                                ...
                                                <button class="btn btn-danger delete"
                                                    url-delete="{{ route('admin.products_color_delete', $productColor->id) }}">
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" class="form-submit" url-store="{{ route('admin.products_color_store', $product->id) }}"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="preview">
                                ...
                                <input class="img-color" hidden accept="image/*" type="file" id="file-input"
                                    name="img" />
                            </div>
                        </div>
                    </div>
    ...
    @vite(['resources/admin/js/product-color.js', 'resources/admin/css/product.css'])
@endsection
