...
@section('content')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-danger delete"
                                                    url-delete="{{ route('admin.delete_size_product', $productSize->id) }}">
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" class="form-submit" url-store="{{ route('admin.store_size_product', $product->id) }}"
                    ...
                    <div class="modal-body">
                        ...
                        <x-admin-input-prepend label="Kích Thước" width="auto">
                            <select url-get-size="{{ route('admin.size_by_product_color') }}" class="form-control"
    ...
    @vite(['resources/admin/js/size.js'])
@endsection
