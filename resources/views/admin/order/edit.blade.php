                    ...
                    <div class="card card-default">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{ $infomation_user['apartment_number'] . ', ' . $infomation_user['ward'] . ', ' . $infomation_user['district'] . ', ' . $infomation_user['city'] }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        @if ($order->order_status != 3)
                            <div class="action col-md-12 pb-3">
                                <button class="btn btn-success" data-toggle="modal" data-target="#modal-lg">Xử Lý Đơn
                                    Hàng</button>
                            </div>
                        @endif
                    </div>
