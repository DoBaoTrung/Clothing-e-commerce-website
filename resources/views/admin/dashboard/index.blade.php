            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <canvas id="pieChart" label="{{ $labelBestSellProduct }}"
                                data="{{ $parameterBestSellProduct }}"
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <canvas id="bestReview" label="{{ $labelBestProductReview }}"
                                data="{{ $parameterBestProductReview }}"
                                style="min-height: 250px; height: 250px; max-height: 250px; max-width: 100%;"></canvas>
                        </div>
                        <!-- /.card-body -->
                    </div>
