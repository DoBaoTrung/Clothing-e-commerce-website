...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('asset/client/images/Chanel.png') }}">
                    ...
                    <div class="col-md-2 col-sm-2">
                        <div class="logo">
                            <a href="{{ route('user.home') }}">
                                <img src="{{ asset('asset/client/images/' . setting_website()->logo) }}" alt="YEEZUS">
                            </a>
                        </div>
                    </div>
                                        ...
                                        <ul class="nav navbar-nav usermenu">
                                            <li class="dropdown">
                                                <a href="#" class="dropdown-toggle profile"
                                                    ...
                                                    <img src="{{ asset('asset/client/images/loginbg.png') }}"
                                                        alt="">
                                                ...
                                                <div class="dropdown-menu">
                                                    <ul class="mega-menu-links">
                                                        <li><a href="{{ route('profile.index') }}">Thông tin cá
                                                                nhân</a></li>
                                                        <li><a href="{{ route('order_history.index') }}">Lịch sử mua
                                                                hàng</a></li>
                            ...
                            <ul class="option">
                                <li id="search" class="search">
                                    <form method="GET" action="{{ route('user.search') }}">
                                        ...
                                        <input class="search-input" placeholder="Nhập sản phẩm bạn muốn tìm"
                                            type="text" value="" name="keyword">
                                    </form>
                                </li>
                                <li class="option-cart">
                                    <a href="{{ route('cart.index') }}" class="cart-icon">cart <span
                                            class="cart_no"></span></a>
                                </li>
                            </ul>
