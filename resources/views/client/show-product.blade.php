                ...
                <form method="get">
                    <div class="col-md-3">
                                ...
                                @foreach ($categories as $category)
                                    <li>
                                        <input type="radio" class="checkboxx" value="{{ $category->slug }}"
                                            {{ $categorySlug == $category->slug ? 'checked' : '' }} name="category_slug">
                                        <a class="name-filter">
                                            {{ $category->name }}
                                        </a>
                                    </li>
                        ...
                        <div class="branch leftbar">
                            ...
                            <ul>
                                <li>
                                    <input type="radio" class="checkboxx" value="" name="brand_id"
                                ...
                                @foreach ($brands as $brand)
                                    <li>
                                        <input type="radio" class="checkboxx" value="{{ $brand->id }}"
                                            {{ $request->brand_id == $brand->id ? 'checked' : '' }} name="brand_id">
                                        <a class="name-filter">
                                            {{ $brand->name }}
                                        </a>
                                    </li>
